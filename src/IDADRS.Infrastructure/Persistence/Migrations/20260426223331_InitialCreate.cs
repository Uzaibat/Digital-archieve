        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AccessDate = table.Column<DateTime>(type: "timestamp with time zone", nullable: false, defaultValueSql: "NOW()"),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_access_logs_documents_DocumentId",
                        column: x => x.DocumentId,
                        principalTable: "documents",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_access_logs_users_UserId",
                        column: x => x.UserId,
                        principalTable: "users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_access_logs_DocumentId",
                table: "access_logs",
                column: "DocumentId");

            migrationBuilder.CreateIndex(
                name: "IX_access_logs_UserId_AccessDate",
                table: "access_logs",
                columns: new[] { "UserId", "AccessDate" });
